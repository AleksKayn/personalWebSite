...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hello, I'm Aleks.</span> I'm a passionate{" "}
        <span className="font-bold">full-stack developer</span> and world    {" "}
        <span className="font-bold">explorer.</span> I enjoy
        creating <span className="italic">visually stunning websites</span>. I use {" "}
      ...
      >
        ...
        <a
          ...
          href="https://www.linkedin.com/in/alex-kayn/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="https://github.com/AleksKayn/"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
